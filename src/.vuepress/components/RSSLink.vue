<template>
  <div class="nav-item vp-action">
    <a class="vp-action-link" :href="`/ecustbook/rss.xml`" target="_blank" rel="noopener noreferrer" aria-label="telegram">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" style="width: 1.25rem; height: 1.25rem; vertical-align: middle">
        <path
